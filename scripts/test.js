...
if(process.platform == 'darwin')
{
	...
	// Sharp x64
	exists('./node_modules/@img/sharp-libvips-darwin-x64/lib/libvips-cpp.8.15.5.dylib', fs.constants.R_OK, 'npm install --cpu=x64 --os=darwin sharp');
	...
	// Sharp arm64
	exists('./node_modules/@img/sharp-libvips-darwin-arm64/lib/libvips-cpp.8.15.5.dylib', fs.constants.R_OK, 'npm install --cpu=arm64 --os=darwin sharp');
