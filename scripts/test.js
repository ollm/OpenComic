...
if(process.platform == 'darwin')
{
	...
	// Sharp x64
	exists('./node_modules/@img/sharp-libvips-darwin-x64/lib/libvips-cpp.8.17.2.dylib', fs.constants.R_OK, 'npm install --cpu=x64 --os=darwin sharp');
	exists('./node_modules/@img/sharp-darwin-x64/lib/sharp-darwin-x64.node', fs.constants.R_OK, 'npm install --cpu=x64 --os=darwin sharp');

	// Sharp arm64
	exists('./node_modules/@img/sharp-libvips-darwin-arm64/lib/libvips-cpp.8.17.2.dylib', fs.constants.R_OK, 'npm install --cpu=arm64 --os=darwin sharp');
...
{	
	...
	// Sharp x64
	exists('./node_modules/@img/sharp-libvips-linux-x64/lib/libvips-cpp.so.8.17.2', fs.constants.R_OK);
	exists('./node_modules/@img/sharp-linux-x64/lib/sharp-linux-x64.node', fs.constants.R_OK);

	// Sharp arm64
	exists('./node_modules/@img/sharp-libvips-linux-arm64/lib/libvips-cpp.so.8.17.2', fs.constants.R_OK, 'npm install --cpu=arm64 --os=linux --libc=glibc sharp');
...
else if(process.platform == 'win32')
{
	...
	exists('./node_modules/@img/sharp-win32-x64/lib/libvips-cpp-8.17.2.dll', fs.constants.R_OK);
	...
	exists('./node_modules/@img/sharp-win32-arm64/lib/libvips-cpp-8.17.2.dll', fs.constants.R_OK, 'npm install --cpu=arm64 --os=win32 sharp');
