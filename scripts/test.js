...
function exists(path, permissions = false)
{
...
if(process.platform == 'darwin')
{
	...
	// Sharp x64
	exists('./node_modules/@img/sharp-libvips-darwin-x64/lib/libvips-cpp.42.dylib', fs.constants.R_OK);
	exists('./node_modules/@img/sharp-darwin-x64/lib/sharp-darwin-x64.node', fs.constants.X_OK | fs.constants.R_OK);

	// Sharp arm64
	exists('./node_modules/@img/sharp-libvips-darwin-arm64/lib/libvips-cpp.42.dylib', fs.constants.R_OK);
	exists('./node_modules/@img/sharp-darwin-arm64/lib/sharp-darwin-arm64.node', fs.constants.X_OK | fs.constants.R_OK);
...
{	
	...
	exists('./node_modules/@img/sharp-libvips-linux-x64/lib/_libvips-cpp.so.42', fs.constants.R_OK);
	...
	exists('./node_modules/@img/sharp-libvips-linux-arm64/lib/libvips-cpp.so.42', fs.constants.R_OK);
	exists('./node_modules/@img/sharp-linuxmusl-arm64/lib/sharp-linuxmusl-arm64.node', fs.constants.X_OK | fs.constants.R_OK);
	exists('./node_modules/@img/sharp-linux-arm64/lib/sharp-linux-arm64.node', fs.constants.X_OK | fs.constants.R_OK);
