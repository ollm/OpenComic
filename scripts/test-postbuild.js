...
if(process.platform == 'darwin')
{
	...
	if(fs.existsSync(darwinArm))
	{
		...
		// Sharp arm64
		exists(darwinArm+'/@img/sharp-libvips-darwin-arm64/lib/libvips-cpp.8.17.2.dylib', fs.constants.R_OK, 'npm install --cpu=arm64 --os=darwin sharp');
	...
	if(fs.existsSync(darwinMas))
	{
		...
		// Sharp x64
		exists(darwinMas+'/@img/sharp-libvips-darwin-x64/lib/libvips-cpp.8.17.2.dylib', fs.constants.R_OK, 'npm install --cpu=x64 --os=darwin sharp');
		exists(darwinMas+'/@img/sharp-darwin-x64/lib/sharp-darwin-x64.node', fs.constants.R_OK, 'npm install --cpu=x64 --os=darwin sharp');

		// Sharp arm64
		exists(darwinMas+'/@img/sharp-libvips-darwin-arm64/lib/libvips-cpp.8.17.2.dylib', fs.constants.R_OK, 'npm install --cpu=arm64 --os=darwin sharp');
...
else if(process.platform == 'linux')
{
	if(fs.existsSync(linux))
	{
		...
		// Sharp x64
		exists(linux+'/@img/sharp-libvips-linux-x64/lib/libvips-cpp.so.8.17.2', fs.constants.R_OK);
	...
	if(fs.existsSync(linuxArm))
	{
		...
		// Sharp arm64
		exists(linuxArm+'/@img/sharp-libvips-linux-arm64/lib/libvips-cpp.so.8.17.2', fs.constants.R_OK);
...
else if(process.platform == 'win32')
{
	if(fs.existsSync(windows))
	{
		...
		exists(windows+'/@img/sharp-win32-x64/lib/libvips-cpp-8.17.2.dll', fs.constants.R_OK);
	...
	if(fs.existsSync(windowsArm))
	{
		...
		exists(windowsArm+'/@img/sharp-win32-arm64/lib/libvips-cpp-8.17.2.dll', fs.constants.R_OK);
